...
\hlkwd{help}\hldef{(separate)}
\hlkwd{help}\hldef{(str_sub)}
\hlkwd{help}\hldef{(str_split)}
\hlkwd{help}\hldef{(str_remove)}
\hlkwd{help}\hldef{(tibble)}
\hlkwd{help}\hldef{(list.files)}
\hlcom{# Step 1}
